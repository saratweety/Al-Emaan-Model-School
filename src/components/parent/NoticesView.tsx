...
export default function NoticesView({ notices }: { notices: NoticeRow[] }) {
  ...
  return (
    <>
      <ParentPageHead
        icon={BellIcon}
        title="Notices"
        subtitle="Important announcements from the school."
        breadcrumb={[{ label: "Dashboard", href: "/parent" }, { label: "Notices" }]}
      />
